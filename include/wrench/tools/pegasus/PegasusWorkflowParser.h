...
namespace wrench {
     ...
     *
     */
        static Workflow *createWorkflowFromJSON(const std::string &filename, const std::string &reference_flop_rate, const double load_factor, bool redundant_dependencies = false);
