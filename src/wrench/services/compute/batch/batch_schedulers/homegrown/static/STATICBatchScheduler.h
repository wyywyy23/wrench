...
#ifndef WRENCH_STATICBATCHSCHEDULER_H
#define WRENCH_STATICBATCHSCHEDULER_H
...
namespace wrench {
     ...
     */
    class STATICBatchScheduler : public HomegrownBatchScheduler {
    ...
    public:
         ...
         */
        explicit STATICBatchScheduler(BatchComputeService *cs) : HomegrownBatchScheduler(cs) {}
	...
	std::map <std::string, std::tuple<unsigned long, double>> scheduleOnStaticHost(long, unsigned long, double);
...
#endif //WRENCH_STATICBATCHSCHEDULER_H
